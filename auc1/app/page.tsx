      ...
      <main className="flex-grow flex flex-col items-center justify-center px-4">
        ...
        <section className="text-center mb-12">
          ...
          <div className="flex flex-wrap justify-center gap-8">
            <div className="w-64 p-6 bg-white rounded-lg shadow-lg transform hover:scale-105 transition-transform duration-300">
              <FaGavel className="text-blue-700 text-4xl mx-auto mb-4" />
        ...
        <div className="flex flex-col items-center gap-8">
          ...
          <div className="text-center">
            ...
            >
              <FaGavel style={{ marginRight: '0.5rem', fontSize: '1.5rem', animation: 'spin 1s linear infinite' }} />
              Enter as Auctioneer
              {loading === '/Auctioneer' && (
                <FaSpinner style={{ animation: 'spin 1s linear infinite', marginLeft: '0.75rem', fontSize: '1.25rem' }} />
              )}
            </button>
          </div>
